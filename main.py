...
# The real process worker logic lives in `worker.py` and is imported at
# the top of this file (`from worker import process_worker`). Keeping a
# single implementation in `worker.py` avoids duplication and makes the
